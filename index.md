...
helper: ["Stephanie Labou (UCSD)", "Reid Otsuji (UCSD)", "Tim Dennis (UCLA)", "Kat Koziar (UCR)", "Scott Peterson (UCB)", "Kimberly Thomas (UCSD)", "Harry Zhou (UCSD)", "Reza Monadi (UCR)", "Erin Foster (UCB)", "Anna Sackmann (UCB)", "Lisa Ngo (UCB)", "Sam Teplitzky (UCB)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
