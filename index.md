...
humandate: "2021 - Sept 13 - 22"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
"Tim Dennis (UCLA)","Kat Koziar (UCR)","Kimberly Thomas (UCSD)","Harry Zhou (UCSD)","Jamie Jamison (UCLA)", "Kristian Allen (UCLA)", "Zhiyuan Yao (UCLA)", "Leigh Phan (UCLA)", "Maddi Cowen (UCLA)", "Lisa McAulay (UCLA)", "Dave George (UCLA)", "Anna Sackmann (UCB)", "Erin Foster (UCB)", "David Palmquist (CSU Fullerton)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stephanie Labou (UCSD)", "Reid Otsuji (UCSD)", "Tim Dennis (UCLA)", "Kat Koziar (UCR)", "Scott Peterson (UCB)", "Kimberly Thomas (UCSD)", "Harry Zhou (UCSD)", "Reza Monadi (UCR)", "Anna Sackmann (UCB)", "Erin Foster (UCB)", "Lisa Ngo (UCB)", "Sam Teplitzky (UCB)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
