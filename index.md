...
"Tim Dennis (UCLA)","Kat Koziar (UCR)","Kimberly Thomas(UCSD)","Harry Zhou(UCSD)","Jamie Jamison (UCLA)", "Kristian Allen (UCLA)", "Zhiyuan Yao (UCLA)", "Leigh Phan (UCLA)", "Maddi Cowen (UCLA)", "Lisa McAulay (UCLA)", "Dave George (UCLA)", "David Palmquist (CSU Fullerton)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Stephanie Labou(UCSD)","Reid Otsuji(UCSD)","Tim Dennis(UCLA)","Kat Koziar (UCR)","Scott Perterson (UCB)", "Kimberly Thomas(UCSD)","Harry Zhou(UCSD)", "Reza Monadi (UCR)","more TBD"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
