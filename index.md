...
"Tim Dennis (UCLA)","Kat Koziar (UCR)","Kimberly Thomas (UCSD)","Harry Zhou (UCSD)","Jamie Jamison (UCLA)", "Kristian Allen (UCLA)", "Zhiyuan Yao (UCLA)", "Leigh Phan (UCLA)", "Maddi Cowen (UCLA)", "Lisa McAulay (UCLA)", "Dave George (UCLA)", "Erin Foster (UCB)", "David Palmquist (CSU Fullerton)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
